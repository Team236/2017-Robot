...
public final class AutoMap {
	...
	// Right gear delivery
	public static final ProfileParameters rightGearLeg1 = new ProfileParameters(94.5, 20, 2, 10, profileMargin);
	public static final double rightGearDegrees = 60;
	public static final ProfileParameters rightGearLeg2 = new ProfileParameters(34.5, 20, 2, 10, profileMargin);
	...
	// Left gear delivery
	public static final ProfileParameters leftGearLeg1 = new ProfileParameters(91, 60, 10, 10, profileMargin);
	public static final double leftTurnDegrees = 60;
	public static final ProfileParameters leftGearLeg2 = new ProfileParameters(23.6, 50, 2, 10, profileMargin);
}
